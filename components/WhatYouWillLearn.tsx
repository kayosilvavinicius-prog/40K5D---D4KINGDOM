            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-6 bg-white/5 rounded-2xl border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">Vou abrir os bastidores de como gerei 40.000 em 5 dias. Um relato prático focado em quem já tem expertise e precisa de liquidez pessoal.</p>
                </div>
              </div>
              <div className="flex gap-4 p-6 bg-white/5 rounded-2xl border border-white/10">
